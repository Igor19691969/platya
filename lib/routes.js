...
module.exports = function(app,order) {
    ...
    app.get('/api/snapshot/stuff/53b176e6a414a1a00d043d43',api.snapshot);
   ...
   /* app.post('/api/users', users.create);
    ...
    app.get('/api/snapshot/:stuff/:id',api.snapshot);
    app.get('/api/snapshot',api.snapshot);
...
//    app.get('/api/snapshot/stuff/:id',api.snapshot);
    ...
    app.get('/api/region',region.list);
